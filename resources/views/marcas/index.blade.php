            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ url ('admin/marcas/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tr class="gradeX">
                    ...
                    @can('marcas.active')                   
                    @if ($marcas->status==1)
                        <form method="post" action="{{ url('admin/marcas/'.$marcas->id.'/inactive')}}">
                            {{ csrf_field() }}
                    ...
                    @else
                        <form method="post" action="{{ url('admin/marcas/'.$marcas->id.'/active')}}">
                            {{ csrf_field() }}
                    ...
                    <td>
                    @can('marcas.edit')
                        <a href="{{ url('admin/marcas/'.$marcas->id.'/edit')}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit">
