    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
            <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__item kt-menu__item--submenu {{ request()->is('') ? 'kt-menu__item kt-menu__item--active kt-menu__item--open kt-menu__item--here' : ''}}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                ...
                </svg></span><span class="kt-menu__link-text">Principal</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu " kt-hidden-height="120" style=""><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">

                            <li class="kt-menu__item {{ request()->is('#') ? 'kt-menu__item kt-menu__item--active kt-menu__item--open kt-menu__item--here' : ''}}" aria-haspopup="true"><a href="{{ url ('#')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Inferior 1</span></a></li>

                            <li class="kt-menu__item {{ request()->is('#') ? 'kt-menu__item kt-menu__item--active kt-menu__item--open kt-menu__item--here' : ''}}" aria-haspopup="true"><a href="{{ url ('#')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Inferior 2</span></a></li>

                            <li class="kt-menu__item {{ request()->is('#') ? 'kt-menu__item kt-menu__item--active kt-menu__item--open kt-menu__item--here' : ''}}" aria-haspopup="true"><a href="{{ url ('#')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Inferior 3</span></a></li>

                            <li class="kt-menu__item {{ request()->is('#') ? 'kt-menu__item kt-menu__item--active kt-menu__item--open kt-menu__item--here' : ''}}" aria-haspopup="true"><a href="{{ url ('#')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Inferior 4</span></a></li>
                ...
                <li class="kt-menu__item  kt-menu__item--submenu {{ request()->is('admin/paises*', 'admin/departamentos*', 'admin/ciudades*','admin/roles*','admin/permisos*', 'admin/usuarios*', 'admin/niveles*', 'admin/grados*', 'admin/catalogos*', 'admin/areas*', 'admin/asignaturas') ? 'kt-menu__item kt-menu__item--active kt-menu__item--open kt-menu__item--here' : ''}}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="{{ url ('/admin/paises/')}}" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24" />
