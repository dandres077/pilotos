        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    <form method="post" class="form-horizontal" action="{{ url('admin/ciudades/'.$data->id.'/edit')}}" autocomplete="off">
                    {{ csrf_field()}}
                        <div class="row">
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">   
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                @foreach ($departamentos as $datos)
                                                    <option value="{{$datos->id}}" @if($data->departamento_id==$datos->id) selected @endif> {{ $datos->nombre, $data->departamento_id }}</option>
                                                @endforeach                                               
                                                </select>
                                            </div>
                                        </div>                                    
                                        ...
                                        <div class="kt-form__actions">
                                            ...
                                            @endcan
                                            <a href="{{ url ('admin/ciudades')}}" class="btn btn-secondary">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
