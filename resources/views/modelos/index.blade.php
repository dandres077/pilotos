        ...
        <div class="kt-portlet__body">
            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tr class="gradeX">
                    <td>{{$modelo->id}}</td>
                    <td>{{$modelo->nom_marca}}</td>
                    <td>{{$modelo->nombre}}</td>
                    <td>{{$modelo->estado_elemento}}</td>
                    <td>   
                        <div class="dropdown dropdown-inline">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="{{ url('admin/modelos/'.$modelo->id.'/edit')}}"><i class="la la-edit"></i>Editar</a>
                                

                                
                                <form method="post" action="{{ url('admin/modelos/'.$modelo->id)}}" class="formulario-eliminar">
                                    @method('DELETE')
                                    {{ csrf_field() }}
                                ...
                                @if ($modelo->status==1)
                                    ...
                                    <form method="post" action="{{ url('admin/modelos/'.$modelo->id.'/inactive')}}">
                                        {{ csrf_field() }}
                                ...
                                @else
                                    ...
                                    <form method="post" action="{{ url('admin/modelos/'.$modelo->id.'/active')}}">
                                        {{ csrf_field() }}
